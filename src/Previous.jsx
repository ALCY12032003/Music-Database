...
<p className='dd'>Now Playing:PERFECT-ED SHEERAN</p><br></br>
<p className='pre'><Link to="/Playlist">Play Previous</Link></p>
<p className='next'><Link to="/Next">Play Next</Link></p>

    <div class="container-audio">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/2Vv-BfVoq4g?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>    </div><br></br>
